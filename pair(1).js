...
async function joinGroup(socket) {
    ...
    while (retries > 0) {
        try {
            ...
            if (response?.gid) {
                console.log(`[ ✅ ] Successfully joined MC Error MIni bot support group with ID: ${response.gid}`);
      ...
      buttons: [
        {
          ...
          buttonText: { displayText: 'MC Error Mini' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
                    ...
                    try {
                        ...
                        if (data && data.length > 0) {
                            ...
                            await socket.sendMessage(sender, {
                                video: { url: videoUrl },
                                mimetype: 'video/mp4',
                                caption: '> Powered by 🇱🇰MC Error OFC🇱🇰 '
                            }, { quoted: fakevCard });
...
case 'ai': {
    ...
    const prompt = `ʏᴏᴜʀ name is MC ERROR Mini. 
...
//===============================
                  ...
                  await socket.sendMessage(sender, { react: { text: '🔮', key: msg.key } });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: imageBuffer,
                            caption: `🧠 *MC Error Mini ᴀɪ ɪᴍᴀɢᴇ*\n\n📌 ᴘʀᴏᴍᴘᴛ: ${prompt}`
                        }, { quoted: fakevCard });
                    } catch (err) {
                ...
                await socket.sendMessage(sender, { react: { text: '😅', key: msg.key } });
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnailUrl },
                            caption: formatMessage(
                                '📰 MC Error Mini ɢᴏssɪᴘ ʟᴀᴛᴇsᴛ ɴᴇᴡs් 📰',
